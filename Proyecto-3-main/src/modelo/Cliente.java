...
public class Cliente extends Usuario {
    ...
    public Cliente(String nombre, String login, String password, String telefono, String correo, Integer balance, Galeria galeria, String tipo) {
    ...
    public Pieza ofertaCompra(Pieza pieza) throws OperacionIlegal {
        if (!this.tipo.equals("Comprador")) {
            throw new OperacionIlegal("Esta operacion solo la puede realizar un usuario con el rol de comprador");
        }
        if (!pieza.isDisponible() || pieza.isBloqueado() || pieza.valorMinimo != null) {
            throw new OperacionIlegal("Esta pieza no puede ser comprada");
        }
    ...
    public boolean verificarAccesoSubasta(Subasta subasta) {
    ...
    public Pieza ofertaSubasta(Subasta subasta, Pieza pieza, Integer valorOferta) throws OperacionIlegal {
        if (!this.tipo.equals("Comprador")) {
            throw new OperacionIlegal("Esta operacion solo la puede realizar un usuario con el rol de comprador");
        }
        if (!pieza.isDisponible() || pieza.getValorMinimo() == null || pieza.isBloqueado() || pieza.getFechaVentaEntrega() != null) {
            throw new OperacionIlegal("Esta pieza no puede estar en una subasta");
        }
        if (valorOferta < pieza.getValor()) {
            throw new OperacionIlegal("Ningun comprador puede ofrecer menos del valor inicial");
        }
        if (!subasta.getVerificados().contains(this)) {
            throw new OperacionIlegal("El usuario no tiene acceso a la subasta");
        }
    ...
    public boolean equals(Object o) {
        if (o instanceof Cliente) {
            ...
            return cliente.getLogin().equals(this.getLogin());
        }
        return false;
    }
